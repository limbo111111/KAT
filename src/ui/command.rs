...
pub fn render_command_line(frame: &mut Frame, area: Rect, app: &App) {
    let (input_text, mode_text, mode_style) = match app.input_mode {
        ...
        InputMode::SignalMenu => (String::new(), "SIGNAL", Style::default().fg(Color::Cyan)),
        ...
        InputMode::HackRfNotDetected => (String::new(), "WARNING", Style::default().fg(Color::Red)),
        InputMode::StartupImport => (String::new(), "IMPORT", Style::default().fg(Color::Yellow)),
        ...
        | InputMode::FobMetaNotes => (String::new(), "EXPORT", Style::default().fg(Color::Green)),
        ...
        | InputMode::CaptureMetaCommand => {
            (String::new(), "META", Style::default().fg(Color::Cyan))
        }
        InputMode::LoadFileBrowser => (String::new(), "LOAD", Style::default().fg(Color::Cyan)),
        InputMode::License => (String::new(), "LICENSE", Style::default().fg(Color::Cyan)),
        InputMode::Credits => (String::new(), "CREDITS", Style::default().fg(Color::Cyan)),
    };
