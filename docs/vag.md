...
VAG supports multiple types (1, 2, 3, 4) with different timing and encryption. Manchester, 80 bits (key1 64 + key2 16). Type 1/2: 300/600 us, prefix 0xAF3F / 0xAF1C. Type 3/4: 500 us, 45 preamble pairs, sync 1000+500 then 3Ã—750 us; key1/key2 not inverted. Type 1/2 use AUT64 or TEA decryption; type 3/4 use AUT64. Button names: Unlock, Lock, Boot. Keys loaded from keystore (VAG raw 64 bytes = 4Ã—16-byte AUT64 keys; lookup by index 1, 2, 3). **Decode and encode** are both supported; encode uses capture data plus stored vag_type/key_idx.

## Timing

- **Type 1/2:** 300 us short, 600 us long, Â±79/80; Preamble1â†’Data1 gap 600 us Â±79; end-of-data gap < 4000 us.
- **Type 3/4:** 500 us short, 1000 us long, Â±80; Preamble2 count 500Â±80; Sync2A 500/1000 us Â±79; Sync2B/Sync2C 750 us Â±79; Data2 short 500Â±120, long 1000Â±120.
...
1. **Reset** â€” 300 us or 500 us (type-dependent) â†’ Preamble1 or Preamble2.
2. **Preamble1** â€” Count; gap 600 us â†’ Data1. **Data1** â€” Manchester; 80 bits; parse type 1/2 (AUT64 or TEA).
3. **Preamble2** â€” Count 500 us pulses; Sync2A (500/1000) â†’ Sync2B (750) â†’ Sync2C (750) â†’ Data2. **Data2** â€” Manchester 80 bits; AUT64 decrypt (type 3/4).
...
VAG AUT64 keys: 4Ã—16-byte packed keys from embedded blob (â€œVAG â€ + 64 bytes) or file. Lookup by `get_vag_key((key_index+1) as u8)` (index 1, 2, 3).
